...
```{r, olive4, out.width = "25%"}
knitr::include_graphics(C:/Users/Rees Morrison/Documents/R/Projects/CLIENTS/Themes/BlogThemes1/static/media/SunOlive.jpg)
```

40width 50 height (don't change output to fig since not dynamic plot), tried pt instead of %

```{r, olive2, fig.width="400pt", fig.height="500pt", eval="TRUE"}
