...
knitr::include_graphics(path = "/media/SunOlive.jpg", error = FALSE) # NOTE REES, error = FALSE

```


<!-- ```{r, olive4, out.width="50%", fig.align = "center", out.extra = 'style="background-color: 9ecff7; padding:10px; "', eval=TRUE, warning=FALSE, message=FALSE, echo=FALSE}
 knitr::include_graphics(path = "/media/SunOlive.jpg", error = FALSE) # display: inline-block;
 ```
-->
